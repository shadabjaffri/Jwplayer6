...
//		protected var _removedButtons:Array = [];
		...
		protected var _defaultLayout:String = "[play prev next elapsed][time alt][duration hd cc mute volumeH largePlayer fullscreen]";
		...
		private function addEventListeners():void {
			...
			player.addEventListener(PlayerEvent.JWPLAYER_LARGEPLAYER,this.largePlayer);
		...
		*/
		...
		private function setupDefaultButtons():void {
			...
			this.addComponentButton("largePlayer",PlayerEvent.JWPLAYER_LARGEPLAYER,true);
		...
		private function largePlayer(param1:PlayerEvent) : void {
         Logger.log("Large player initiated");
      }
