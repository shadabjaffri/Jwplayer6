package com.longtailvideo.jwplayer.controller {
	...
	import com.longtailvideo.jwplayer.plugins.related.*;
    import com.longtailvideo.jwplayer.plugins.sharing.*;
	...
	public class PlayerSetup extends EventDispatcher {
		...
		protected function loadPluginsComplete(event:Event=null):void {
                ...
                if (confHash.hasOwnProperty("sharing")) 
                {
                    _view.addPlugin("sharing", new com.longtailvideo.jwplayer.plugins.sharing.Sharing());
                }
           
            
                if (confHash.hasOwnProperty("related")) 
                {
                    _view.addPlugin("related", new com.longtailvideo.jwplayer.plugins.related.Related());
                }
